%==============================================
% WorldTheory.pl for actor autopilot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuautopilot).	%%old version (deprecated)
actorobj(qatuautopilot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor autopilot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of autopilot" ). 
...
%-------------------------------------------------
%  User static rules about autopilot
%------------------------------------------------- 
/*
------------------------------------------------------------------------
