%==============================================
% WorldTheory.pl for actor mindrobotanalysis
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumindrobotanalysis).	%%old version (deprecated)
actorobj(qatumindrobotanalysis).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mindrobotanalysis
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mindrobotanalysis" ). 
...
%-------------------------------------------------
%  User static rules about mindrobotanalysis
%------------------------------------------------- 
eval( let,X,X).
