%==============================================
% WorldTheory.pl for actor testanalysistime
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutestanalysistime).	%%old version (deprecated)
actorobj(qatutestanalysistime).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor testanalysistime
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of testanalysistime" ). 
...
%-------------------------------------------------
%  User static rules about testanalysistime
%------------------------------------------------- 
/*
------------------------------------------------------------------------
