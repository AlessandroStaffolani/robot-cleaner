%==============================================
% WorldTheory.pl for actor delegateexecutor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatudelegateexecutor).	%%old version (deprecated)
actorobj(qatudelegateexecutor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor delegateexecutor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of delegateexecutor" ). 
...
%-------------------------------------------------
%  User static rules about delegateexecutor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
