%==============================================
% WorldTheory.pl for actor ledmockledanalysis
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuledmockledanalysis).	%%old version (deprecated)
actorobj(qatuledmockledanalysis).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor ledmockledanalysis
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of ledmockledanalysis" ). 
...
%-------------------------------------------------
%  User static rules about ledmockledanalysis
%------------------------------------------------- 
/*
------------------------------------------------------------------------
