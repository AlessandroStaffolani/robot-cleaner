%==============================================
% WorldTheory.pl for actor robotexecutormockledanalysis
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobotexecutormockledanalysis).	%%old version (deprecated)
actorobj(qaturobotexecutormockledanalysis).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robotexecutormockledanalysis
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robotexecutormockledanalysis" ). 
...
%-------------------------------------------------
%  User static rules about robotexecutormockledanalysis
%------------------------------------------------- 
/*
------------------------------------------------------------------------
