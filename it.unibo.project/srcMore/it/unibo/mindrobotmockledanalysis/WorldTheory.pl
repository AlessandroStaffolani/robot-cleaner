%==============================================
% WorldTheory.pl for actor mindrobotmockledanalysis
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumindrobotmockledanalysis).	%%old version (deprecated)
actorobj(qatumindrobotmockledanalysis).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mindrobotmockledanalysis
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mindrobotmockledanalysis" ). 
...
%-------------------------------------------------
%  User static rules about mindrobotmockledanalysis
%------------------------------------------------- 
eval( let,X,X).
