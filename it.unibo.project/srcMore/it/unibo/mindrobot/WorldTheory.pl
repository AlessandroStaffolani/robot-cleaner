%==============================================
% WorldTheory.pl for actor mindrobot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumindrobot).	%%old version (deprecated)
actorobj(qatumindrobot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mindrobot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mindrobot" ). 
...
%-------------------------------------------------
%  User static rules about mindrobot
%------------------------------------------------- 
/*
------------------------------------------------------------------------
