...
package it.unibo.robotexecutoranalysis;
...
public abstract class AbstractRobotexecutoranalysis extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractRobotexecutoranalysis(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/robotexecutoranalysis/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/robotexecutoranalysis/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "robotexecutoranalysis tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	//switchTo waitForCmd
	        switchToPlanAsNextState(pr, myselfName, "robotexecutoranalysis_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"robotexecutoranalysis_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("execMove",-1);
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"robotexecutoranalysis_"+myselfName,false,true);
