...
public abstract class AbstractTestanalysistime extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractTestanalysistime(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/testanalysistime/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/testanalysistime/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "testanalysistime tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "\"Test time ready\"";
	    	println( temporaryStr );  
	    	//switchTo waitPlan
	        switchToPlanAsNextState(pr, myselfName, "testanalysistime_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"testanalysistime_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleEvent",-1);
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"testanalysistime_"+myselfName,false,true);
