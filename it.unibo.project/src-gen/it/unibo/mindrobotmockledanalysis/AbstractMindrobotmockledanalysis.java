...
public abstract class AbstractMindrobotmockledanalysis extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractMindrobotmockledanalysis(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/mindrobotmockledanalysis/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/mindrobotmockledanalysis/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "mindrobotmockledanalysis tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	//switchTo waitPlan
	        switchToPlanAsNextState(pr, myselfName, "mindrobotmockledanalysis_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"mindrobotmockledanalysis_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleEvent",-1);
	    	...
	    	sendMsg("execMoveRobot","robotexecutormockledanalysis", QActorContext.dispatch, temporaryStr ); 
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"mindrobotmockledanalysis_"+myselfName,false,true);
