...
public abstract class AbstractRobotexecutormockledanalysis extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractRobotexecutormockledanalysis(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/robotexecutormockledanalysis/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/robotexecutormockledanalysis/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		...
	    		println( "robotexecutormockledanalysis tout : stops");  
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	//switchTo waitForCmd
	        switchToPlanAsNextState(pr, myselfName, "robotexecutormockledanalysis_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"robotexecutormockledanalysis_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("execMove",-1);
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"robotexecutormockledanalysis_"+myselfName,false,true);
