...
public abstract class AbstractAutopilot extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractAutopilot(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/autopilot/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/autopilot/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("init",-1);
	    	...
	    	temporaryStr = "\"Autopilot ready\"";
	    	println( temporaryStr );  
	    	//switchTo waitForCmd
	        switchToPlanAsNextState(pr, myselfName, "autopilot_"+myselfName, 
	    ...
	    try{	
	     ...
	     pr.incNumIter(); 	
	    	...
	    	//bbb
	     msgTransition( pr,myselfName,"autopilot_"+myselfName,false,
	    ...
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp("handleExecMsg",-1);
	    	...
	    	curT = Term.createTerm("mindcmd(auto(X))");
	    	...
	    	repeatPlanNoTransition(pr,myselfName,"autopilot_"+myselfName,false,true);
