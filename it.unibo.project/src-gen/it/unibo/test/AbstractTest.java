...
public abstract class AbstractTest extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractTest(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/test/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/test/plans.txt";
	  	}
		@Override
